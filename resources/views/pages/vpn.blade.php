...
<head>
    ...
    <title>VPN Server Store - Parsa Besharat</title>
...
<body
    ...
    <div id="main-container"
        ...
        @include('sidebar')
        <main class="flex-1 p-8 pt-12 lg:p-14 lg:pt-14 relative flex flex-col justify-center items-center overflow-y-auto">
            <div class="relative z-10 text-center animate-page-slide-up">
