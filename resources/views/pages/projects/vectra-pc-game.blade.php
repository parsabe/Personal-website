        ...
        <main class="flex-1 overflow-y-auto p-6 md:p-10 scroll-smooth">
            <div class="max-w-4xl mx-auto space-y-10">
                ...
                <section class="space-y-6">
                    ...
                    <!-- Phase 1 Card -->
                    <div class="bg-white/95 dark:bg-gray-950/85 backdrop-blur-md p-6 rounded-2xl border border-gray-300 dark:border-gray-800 shadow-xl space-y-4">
                        <div class="flex items-center justify-between">
                            <h3 class="text-xl font-extrabold text-emerald-700 dark:text-emerald-400">Phase 1: The Construct</h3>
                            <span class="px-3 py-1 bg-emerald-500/15 text-emerald-800 dark:text-emerald-300 text-xs font-mono rounded-full font-extrabold border border-emerald-500/30">Intro Stage</span>
                        </div>
                        ...
                        <div class="grid md:grid-cols-2 gap-4 pt-2">
                            <div class="p-4 rounded-xl bg-blue-500/10 dark:bg-blue-950/60 border border-blue-500/30 dark:border-blue-500/50 space-y-1">
                            ...
                            <div class="p-4 rounded-xl bg-red-500/10 dark:bg-red-950/60 border border-red-500/30 dark:border-red-500/50 space-y-1">
                    ...
                    <div class="bg-white/95 dark:bg-gray-950/85 backdrop-blur-md p-6 rounded-2xl border border-gray-300 dark:border-gray-800 shadow-xl space-y-4">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="px-3 py-1 bg-teal-500/15 text-teal-800 dark:text-teal-300 text-xs font-mono rounded-full font-extrabold border border-teal-500/30">Mainframe Arena</span>
                        </div>
                        ...
                        <ol class="space-y-3 text-sm text-gray-900 dark:text-gray-100 list-decimal list-inside ml-2 font-medium">
                            <li class="pl-2"><strong class="text-gray-900 dark:text-white font-extrabold">The Oracle:</strong> Speaks to you about trust, choices, and the impending purge. As she finishes, she fades out, and the ambient soundtrack <code class="px-2 py-0.5 bg-emerald-500/15 text-emerald-800 dark:text-emerald-300 border border-emerald-500/30 rounded text-xs font-mono font-bold">doomed.mp3</code> begins playing softly in the background.</li>
                            ...
                            <li class="pl-2"><strong class="text-gray-900 dark:text-white font-extrabold">Trinity:</strong> Spawns and fades in after Agent Smith's defeat. She provides the encrypted security payload: <code class="px-2 py-0.5 bg-emerald-500/15 text-emerald-800 dark:text-emerald-300 border border-emerald-500/30 rounded text-xs font-mono font-bold">V ungr Zngurzngvpf</code>.</li>
                            ...
                            <li class="pl-2"><strong class="text-gray-900 dark:text-white font-extrabold">The Laptop Terminal:</strong> Press <kbd class="px-2.5 py-0.5 bg-gray-200 dark:bg-gray-800 text-gray-900 dark:text-white border border-gray-400 dark:border-gray-600 rounded text-xs font-mono font-bold shadow-sm">E</kbd> near the laptop to open the Cyberpunk ROT13 Mainframe Terminal. Decipher the key (<code class="px-2 py-0.5 bg-emerald-500/15 text-emerald-800 dark:text-emerald-300 border border-emerald-500/30 rounded text-xs font-mono font-bold">V ungr Zngurzngvpf</code> &rarr; <code class="px-2 py-0.5 bg-emerald-500/15 text-emerald-800 dark:text-emerald-300 border border-emerald-500/30 rounded text-xs font-mono font-bold">I hate Mathematics</code>), submit it, and purge the mainframe!</li>
                            <li class="pl-2"><strong class="text-gray-900 dark:text-white font-extrabold">Victory Screen:</strong> Plays <code class="px-2 py-0.5 bg-emerald-500/15 text-emerald-800 dark:text-emerald-300 border border-emerald-500/30 rounded text-xs font-mono font-bold">ending.mp3</code> and presents the final credits overlay with developer links and music soundtrack copyright information.</li>
                        </ol>
                    </div>

                    <!-- Matrix Lore Notice -->
                    <div class="p-5 bg-amber-500/10 dark:bg-amber-950/60 border border-amber-500/30 dark:border-amber-500/50 rounded-2xl flex items-start gap-3 shadow-md">
                ...
                <section class="space-y-4">
                    ...
                    <div class="overflow-hidden rounded-2xl border border-gray-300 dark:border-gray-800 bg-white/95 dark:bg-gray-950/85 backdrop-blur-md shadow-xl">
                        <table class="w-full text-left text-sm">
                            <thead class="bg-gray-200/90 dark:bg-gray-900/90 text-gray-900 dark:text-white font-black border-b border-gray-300 dark:border-gray-800 uppercase tracking-wider text-xs">
                                <tr>
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-800 text-gray-900 dark:text-gray-100 font-medium">
                                <tr class="hover:bg-gray-100/80 dark:hover:bg-gray-900/60 transition-colors">
                                    <td class="p-4 font-black text-gray-900 dark:text-white">3D Models & Assets</td>
                                    <td class="p-4"><span class="px-2.5 py-1 bg-purple-500/15 dark:bg-purple-950/80 text-purple-900 dark:text-purple-300 border border-purple-500/30 rounded-md text-xs font-mono font-bold">Meshy.ai</span></td>
                                ...
                                <tr class="hover:bg-gray-100/80 dark:hover:bg-gray-900/60 transition-colors">
                                    ...
                                    <td class="p-4"><span class="px-2.5 py-1 bg-blue-500/15 dark:bg-blue-950/80 text-blue-900 dark:text-blue-300 border border-blue-500/30 rounded-md text-xs font-mono font-bold">Unity 3D (C#)</span></td>
                                ...
                                <tr class="hover:bg-gray-100/80 dark:hover:bg-gray-900/60 transition-colors">
                                    ...
                                    <td class="p-4"><span class="px-2.5 py-1 bg-emerald-500/15 dark:bg-emerald-950/80 text-emerald-900 dark:text-emerald-300 border border-emerald-500/30 rounded-md text-xs font-mono font-bold">Suno Bark TTS</span></td>
                                ...
                                <tr class="hover:bg-gray-100/80 dark:hover:bg-gray-900/60 transition-colors">
                                    ...
                                    <td class="p-4"><span class="px-2.5 py-1 bg-amber-500/15 dark:bg-amber-950/80 text-amber-900 dark:text-amber-300 border border-amber-500/30 rounded-md text-xs font-mono font-bold">Ollama LLM API</span></td>
                                ...
                                <tr class="hover:bg-gray-100/80 dark:hover:bg-gray-900/60 transition-colors">
                                    ...
                                    <td class="p-4"><span class="px-2.5 py-1 bg-red-500/15 dark:bg-red-950/80 text-red-900 dark:text-red-300 border border-red-500/30 rounded-md text-xs font-mono font-bold">ROT13 Cipher</span></td>
                                ...
                                <tr class="hover:bg-gray-100/80 dark:hover:bg-gray-900/60 transition-colors">
                                    ...
                                    <td class="p-4"><span class="px-2.5 py-1 bg-teal-500/15 dark:bg-teal-950/80 text-teal-900 dark:text-teal-300 border border-teal-500/30 rounded-md text-xs font-mono font-bold">Runtime Vector GUI</span></td>
                        ...
                        <table class="w-full text-left text-sm">
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-800 text-gray-900 dark:text-gray-100 font-medium">
                                ...
                                <tr class="hover:bg-gray-100/80 dark:hover:bg-gray-900/60 transition-colors">
                                    ...
                                    <td class="p-4"><kbd class="px-3 py-1 bg-emerald-500/20 text-emerald-900 dark:text-emerald-300 border border-emerald-500/30 rounded text-xs font-mono font-bold shadow-sm">E</kbd></td>
                                ...
                                <tr class="hover:bg-gray-100/80 dark:hover:bg-gray-900/60 transition-colors">
                                    ...
                                    <td class="p-4"><kbd class="px-3 py-1 bg-blue-500/20 text-blue-900 dark:text-blue-300 border border-blue-500/30 rounded text-xs font-mono font-bold shadow-sm">Q</kbd></td>
...
.\venv\Scripts\python.exe generate_trinity_voices.py</code></pre>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-xs font-mono">
                        <div class="p-4 bg-white/95 dark:bg-gray-950/85 border border-gray-300 dark:border-gray-800 rounded-xl shadow-md space-y-1">
                            ...
                            <span class="text-gray-700 dark:text-gray-200 text-xs block font-medium">Deep male voice</span>
                        </div>
                        <div class="p-4 bg-white/95 dark:bg-gray-950/85 border border-gray-300 dark:border-gray-800 rounded-xl shadow-md space-y-1">
                            ...
                            <span class="text-gray-700 dark:text-gray-200 text-xs block font-medium">Warm female voice</span>
                        </div>
                        <div class="p-4 bg-white/95 dark:bg-gray-950/85 border border-gray-300 dark:border-gray-800 rounded-xl shadow-md space-y-1">
                            ...
                            <span class="text-gray-700 dark:text-gray-200 text-xs block font-medium">Intimidating male</span>
                        </div>
                        <div class="p-4 bg-white/95 dark:bg-gray-950/85 border border-gray-300 dark:border-gray-800 rounded-xl shadow-md space-y-1">
                            ...
                            <span class="text-gray-700 dark:text-gray-200 text-xs block font-medium">Clear female voice</span>
                        </div>
                    </div>
                </section>
                ...
                <section class="space-y-4">
                    ...
                    <div class="grid md:grid-cols-3 gap-4 text-sm">
                        <a href="https://open.spotify.com/intl-de/track/1yUaqPpTl2UEnF31L3r62O?si=6912dd797e734111" target="_blank"
                           class="p-4 bg-emerald-500/10 dark:bg-emerald-950/60 hover:bg-emerald-500/20 dark:hover:bg-emerald-900/70 border border-emerald-500/30 dark:border-emerald-500/50 rounded-2xl transition flex items-center justify-between group shadow-sm">
                            <div>
                        ...
                        <a href="https://youtu.be/Y_-6JcqTuQg?si=zqyu86zmAYBtSiNv" target="_blank"
                           class="p-4 bg-red-500/10 dark:bg-red-950/60 hover:bg-red-500/20 dark:hover:bg-red-900/70 border border-red-500/30 dark:border-red-500/50 rounded-2xl transition flex items-center justify-between group shadow-sm">
                            <div>
                        ...
                        <a href="https://youtu.be/08wg9S_elHY?si=E92hpVnRs6I5eQZm" target="_blank"
                           class="p-4 bg-purple-500/10 dark:bg-purple-950/60 hover:bg-purple-500/20 dark:hover:bg-purple-900/70 border border-purple-500/30 dark:border-purple-500/50 rounded-2xl transition flex items-center justify-between group shadow-sm">
                            <div>
                ...
                <section class="space-y-4 pb-6">
                    ...
                    <div class="flex flex-wrap gap-4 text-sm font-extrabold pt-1">
                        <a href="https://parsabe.com" class="px-4 py-2 bg-emerald-500/15 dark:bg-emerald-950/60 text-emerald-900 dark:text-emerald-300 border border-emerald-500/40 rounded-xl hover:bg-emerald-500/25 transition">🌐 Portfolio Website (parsabe.com)</a>
                        <a href="https://linkedin.com/in/parsabe" target="_blank" class="px-4 py-2 bg-blue-500/15 dark:bg-blue-950/60 text-blue-900 dark:text-blue-300 border border-blue-500/40 rounded-xl hover:bg-blue-500/25 transition">💼 LinkedIn</a>
                        <a href="https://github.com/parsabe" target="_blank" class="px-4 py-2 bg-gray-500/15 dark:bg-gray-800/80 text-gray-900 dark:text-white border border-gray-500/40 rounded-xl hover:bg-gray-500/25 transition">🐙 GitHub</a>
                    </div>
                </section>
