...
<head>
    ...
    <meta name="description" content="Vectra is an end-to-end framework designed to generate, extract, and simulate high-fidelity 3D objects from 2D inputs. Research paper by Parsa Besharat.">
    <meta name="author" content="Parsa Besharat">
    <meta name="keywords" content="Vectra, Spatial Computing, 3D Gaussian Splatting, Neural Rendering, Physics Simulation, Generative AI, Parsa Besharat, Research Paper">
    ...
    <meta property="og:description" content="Vectra is an end-to-end framework designed to generate, extract, and simulate high-fidelity 3D objects from 2D inputs.">
                ...
                <section
                    ...
                    <div class="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <span
                                class="px-3 py-1 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 text-xs font-semibold rounded-full">3D Content Creation</span>
                            <span
                                class="px-3 py-1 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 text-xs font-semibold rounded-full">3D Gaussian Splatting</span>
                            <span
                                class="px-3 py-1 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 text-xs font-semibold rounded-full">Neural Rendering</span>
                            <span
                                class="px-3 py-1 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 text-xs font-semibold rounded-full">Physics Simulation</span>
                            <span
                                class="px-3 py-1 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 text-xs font-semibold rounded-full">Generative AI</span>
                        </div>
                    </div>
                </section>

                <div class="flex flex-col sm:flex-row justify-center items-center gap-4 pt-4">
                    <a href="https://www.researchgate.net/profile/Parsa-Besharat"
                        target="_blank"
                    ...
                    <a href="https://vectra.parsabe.com"
                        target="_blank"
