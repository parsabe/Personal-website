            ...
            <div class="max-w-4xl mx-auto space-y-12 pb-20">
                ...
                <header class="text-center space-y-6 pt-4">
                    ...
                    <h1 class="text-4xl md:text-5xl font-extrabold tracking-tight text-gray-900 dark:text-white drop-shadow-sm leading-tight">
                        Exploring the Synergy of Blockchain and Artificial Intelligence
                    </h1>
                ...
                <section class="bg-white/60 dark:bg-gray-800/60 backdrop-blur-md rounded-3xl p-8 border border-white/20 shadow-lg relative overflow-hidden">
                    ...
                    <div class="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            <span class="px-3 py-1 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 text-xs font-semibold rounded-full">Data Management</span>
                            <span class="px-3 py-1 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 text-xs font-semibold rounded-full">Decentralized Intelligence</span>
                ...
                <div class="flex justify-center pt-4">
                    <a href="https://www.researchgate.net/publication/392626581_Exploring_the_Synergy_of_Blockchain_and_Artificial_Intelligence" target="_blank" 
