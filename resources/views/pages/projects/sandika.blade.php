            ...
            <div class="max-w-4xl mx-auto space-y-12">
                ...
                <div class="text-center space-y-6">
                    ...
                    <div class="prose dark:prose-invert max-w-none text-gray-600 dark:text-gray-300 leading-relaxed text-center md:text-lg">
                        <p>Sandika is a simple online social media platform where people can post texts, images, videos, solve riddles, and more.</p>
                    </div>
                </div>

                <section class="space-y-4">
                    <div class="flex items-center gap-3 border-b border-gray-200 dark:border-gray-700 pb-3">
                        <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Setup & Installation</h2>
                    </div>
                    
                    <p class="text-gray-600 dark:text-gray-300">To get started, clone the repository and configure the file paths according to your web server's environment.</p>

                    <pre class="bg-[#1e1e1e] text-[#d4d4d4] p-4 rounded-xl shadow-inner border border-gray-700/50 overflow-x-auto text-sm font-mono mt-3 mb-4"><code>git clone https://github.com/parsabe/Sandika.git</code></pre>
                    
                    <ul class="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-300 ml-2 mt-4">
                        <li>Ensure you set the paths of each file to an appropriate directory based on the web server you are using (e.g., Apache, Nginx, etc.).</li>
                    </ul>
                </section>
