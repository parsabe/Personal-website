            ...
            <div class="max-w-4xl mx-auto space-y-10">
                ...
                <div class="text-center space-y-6">
                    ...
                    <div class="prose dark:prose-invert max-w-none text-gray-600 dark:text-gray-300 leading-relaxed text-justify">
                        <p>All my Fun Projects and practices are here. Feel free to join.</p>
                ...
                <section class="space-y-4">
                    <div class="flex items-center gap-3 border-b border-gray-200 dark:border-gray-700 pb-3">
                        <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Current Projects</h2>
                    </div>
                    <ul class="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-300">
                        <li><a href="https://github.com/parsabe/FunRoot/tree/master/matrix-grub" class="text-blue-600 dark:text-blue-400 hover:underline">Matrix Grub</a></li>
                        <li><a href="https://github.com/parsabe/FunRoot/tree/master/Chess%20py%20game" class="text-blue-600 dark:text-blue-400 hover:underline">Chess pygame</a></li>
                        <li><a href="https://github.com/parsabe/FunRoot/tree/master/devops-roadmap" class="text-blue-600 dark:text-blue-400 hover:underline">DevOps RoadMap</a></li>
                        <li><a href="https://github.com/parsabe/FunRoot/tree/master/ChatApp" class="text-blue-600 dark:text-blue-400 hover:underline">ChatApp</a></li>
                        <li><a href="https://github.com/parsabe/FunRoot/tree/master/2048" class="text-blue-600 dark:text-blue-400 hover:underline">2048</a></li>
                        <li><a href="https://github.com/parsabe/FunRoot/tree/master/Dancer" class="text-blue-600 dark:text-blue-400 hover:underline">Dancer</a></li>
                    </ul>
                </section>
