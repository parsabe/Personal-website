...
<body class="flex flex-col min-h-screen text-slate-300 font-sans antialiased relative overflow-hidden">
    ...
    <header class="w-full max-w-7xl mx-auto px-6 py-6 flex justify-between items-center relative z-10">
        <a href="/" class="flex items-center space-x-2 text-xl font-bold tracking-widest font-mono text-white hover:opacity-90 transition-opacity">
    ...
    <main class="flex-grow flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12 relative z-10">
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-8">
                <div class="inline-flex items-center justify-center p-3 bg-red-500/5 rounded-2xl border border-[#ff0077]/30 mb-4 shadow-[0_0_15px_rgba(255,0,119,0.1)]">
                    <svg class="w-9 h-9 text-[#ff0077] animate-pulse" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="cyber-card rounded-3xl p-8 sm:p-10">
                ...
                @if($isSetup)
                    ...
                    <div class="mb-6 space-y-5">
                        <div class="p-4 bg-[#ff0077]/5 border border-[#ff0077]/30 rounded-xl text-xs font-mono text-slate-300 leading-relaxed">
                        ...
                        <!-- QR Code Container -->
                        <div class="flex justify-center p-4 bg-white rounded-2xl max-w-[200px] mx-auto border border-[#00f0ff]/30 shadow-[0_0_15px_rgba(0,240,255,0.1)]">
                        ...
                        <div class="text-center p-3.5 bg-black/80 rounded-xl border border-slate-800">
                            <span class="block text-[9px] font-bold font-mono tracking-widest text-slate-500 uppercase mb-1">Backup Key</span>
                            <span class="font-mono text-base font-bold text-[#00f0ff] tracking-widest text-glow-cyan">{{ $secret }}</span>
                        </div>
                    </div>
                @endif
                ...
                <form action="{{ route('parsa.2fa.verify') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        <button type="submit" class="cyber-btn w-full flex justify-center py-4 px-4 rounded-xl text-xs font-bold uppercase tracking-widest">
                            Authorize Session
                        </button>
                    </div>
                </form>
    ...
    <!-- Footer -->
    <footer class="w-full max-w-7xl mx-auto px-6 py-6 text-center font-mono text-[9px] text-slate-600 tracking-wider relative z-10">
