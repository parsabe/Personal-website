    ...
    <div id="main-container" class="ios-glass relative w-full max-w-6xl flex flex-col md:flex-row rounded-[2.5rem] overflow-hidden h-[85vh] z-10 transition-colors duration-700">
        ...
        <main class="flex-1 p-8 lg:p-14 relative overflow-y-auto">
            <div class="relative z-10 mt-12 lg:mt-0">
                <h1 class="text-4xl font-bold mb-6">Quantum-dot Cellular Automata (QCA)</h1>
                <p class="mb-6">Islamic Azad University • Apr 15, 2019</p>
                <a href="https://www.researchgate.net/publication/392637941_Quantum-dot_Cellular_Automata_QCA" target="_blank" class="text-blue-500 hover:underline">View on ResearchGate</a>
            </div>
        </main>
    </div>
</body>
